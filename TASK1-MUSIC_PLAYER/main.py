...
# All the frames
song_frame = LabelFrame(root, text='Current Song', bg='silver', width=400, height=80)
song_frame.place(x=0, y=0)

button_frame = LabelFrame(root, text='Buttons', bg='Turquoise', width=400, height=120)
...
stop_btn = Button(button_frame, text='Stop', bg='coral', font=("Georgia", 13), width=7,
                  command=lambda: stop_song(song_status))
stop_btn.place(x=105, y=10)

play_btn = Button(button_frame, text='Play', bg='coral', font=("Georgia", 13), width=7,
...
load_btn = Button(button_frame, text='Load Directory', bg='coral', font=("Georgia", 13), width=35,
